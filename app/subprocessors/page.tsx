...
export const metadata: Metadata = { title: "Subprocessors — LicenseSizer", description: "Third-party infrastructure used to operate LicenseSizer." };

export default function SubprocessorsPage() {
  return <LegalShell eyebrow="Trust center" title="Subprocessors" intro="LicenseSizer uses a small set of infrastructure providers for account access, hosting, configuration data, and billing. License images and PDFs are not intentionally sent to these providers by LicenseSizer.">
    ...
    <section><h2>Changes</h2><p>We may update this list when providers or processing purposes change. Dealerships with contractual notice requirements should contact <a href="mailto:privacy@licensesizer.com">privacy@licensesizer.com</a>.</p></section>
  </LegalShell>;
}
