  ...
  return (
    <main className="marketing-shell">
      <nav className="marketing-nav" aria-label="Main navigation">
        <a className="brand" href="#top" aria-label="LicenseSizer home"><span className="brand-mark" aria-hidden="true"><i /></span><span>License<span>Sizer</span></span></a>
      ...
      <section className="marketing-hero" id="top">
        ...
        <div className="hero-product" aria-label="LicenseSizer customer workflow preview">
          ...
          <div className="floating-card floating-complete"><span className="float-check">✓</span><div><b>PDF delivered</b><small>Just now</small></div></div>
        </div>
      </section>
      ...
      <section className="problem-section"><div><p className="marketing-kicker">A cleaner process</p><h2>Your team has better things to do than crop license photos.</h2></div><p>LicenseSizer replaces blurry text messages, awkward email threads, and manual resizing with one consistent customer workflow.</p></section>
      ...
      <section className="workflow-section" id="how-it-works">
        ...
        <article><span>03</span><div className="feature-icon">✓</div><h3>Your team receives</h3><p>A consistent, true-size PDF arrives through the customer’s chosen app.</p></article>
      </section>

      <section className="control-section">
        <div className="control-copy"><p className="marketing-kicker">Set it once</p><h2>Your process.<br />Every time.</h2><p>Control the format behind the scenes, so customers only see the few steps they need.</p><ul><li><span>✓</span><div><b>Branded customer link</b><small>Your dealership name, your destination.</small></div></li><li><span>✓</span><div><b>Consistent PDF output</b><small>Front, back, page size, labels, and image detail.</small></div></li><li><span>✓</span><div><b>Lightweight activity reporting</b><small>See completed handoffs without storing documents.</small></div></li></ul></div>
        <div className="console-preview" aria-label="Dealer console preview"><div className="console-top"><b>LicenseSizer</b><span>Ridgeline Motors⌄</span></div><div className="console-grid"><aside><small>ORGANIZATION</small><b>Dealer console</b><span className="active">Overview</span><span>Delivery setup</span><span>Admins &amp; users</span><span>Plan &amp; billing</span></aside><div className="console-main"><small>LAST 30 DAYS</small><h3>Good morning.</h3><div className="metrics"><div><b>142</b><span>Sessions</span></div><div><b>119</b><span>PDFs created</span></div><div><b>84%</b><span>Completion</span></div></div><div className="activity"><b>Recent activity</b><span><i>✓</i> PDF created <small>2 min ago</small></span><span><i>↗</i> Delivery opened <small>8 min ago</small></span><span><i>✓</i> PDF created <small>14 min ago</small></span></div></div></div></div>
      </section>

      <section className="privacy-section" id="privacy"><div className="privacy-seal"><span>◉</span><small>ON-DEVICE<br />PROCESSING</small></div><div><p className="marketing-kicker light">Privacy is the product</p><h2>The license image never becomes our data.</h2></div><div><p>Photos and PDFs stay in volatile browser memory on the customer’s device. LicenseSizer stores dealership settings and minimal workflow events—not license images, names, filenames, or document content.</p><a href="/capture">See the experience <span>→</span></a></div></section>
      ...
      <footer className="marketing-footer"><a className="brand" href="#top"><span className="brand-mark" aria-hidden="true"><i /></span><span>License<span>Sizer</span></span></a><p>Private document capture for dealerships.</p><div><a href="/capture">Product demo</a><a href="/dashboard">Dealer sign in</a><a href="#privacy">Privacy</a></div><small>© {new Date().getFullYear()} LicenseSizer. LicenseSizer resizes documents; it does not verify identity or authenticity.</small></footer>
    </main>
  );
}
