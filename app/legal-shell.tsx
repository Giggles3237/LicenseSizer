...
export default function LegalShell({ eyebrow, title, intro, children }: { eyebrow: string; title: string; intro: string; children: ReactNode }) {
  return <main className="legal-shell">
    ...
    <footer className="legal-footer"><p>LicenseSizer prepares documents locally. It does not verify identity, authenticate licenses, choose recipients, or confirm delivery.</p><Link href="/">Return home</Link></footer>
  </main>;
}
